...
Kalaido CLA version 1.0 — based on Harmony (HA-CLA-I-V1). See [Provenance](#provenance).

Thank you for your interest in contributing to software projects managed by North Shore Software Ltd. ("We" or "Us").
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document
effective, please email <cla@northshoresoftware.ca>. We will reply with a link to sign this Agreement electronically.
...
Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions
in <https://github.com/north-shore-software/kalaido/blob/main/CONTRIBUTING.md#third-party-material>.
...
In addition, We may use the following licenses for Media in the Contribution: CC0-1.0, CC-BY-4.0, CC-BY-SA-4.0
...
(d) You have followed the instructions
in <https://github.com/north-shore-software/kalaido/blob/main/CONTRIBUTING.md#third-party-material>, if You do not own
...
6.1 This Agreement will be governed by and construed in accordance with the laws of British Columbia, Canada excluding
its conflicts of law provisions. Under certain circumstances, the governing law in this section might be superseded by
the United Nations Convention on Contracts for the International Sale of Goods ("UN Convention") and the parties intend
to avoid the application of the UN Convention to this Agreement and, thus, exclude the application of the UN Convention
...
This Agreement is an adaptation of the **Harmony Individual Contributor License Agreement, HA-CLA-I-V1**, published by
the Harmony project at <https://www.harmonyagreements.org>. The original template is licensed under a
[Creative Commons Attribution 3.0 Unported License](https://creativecommons.org/licenses/by/3.0/), and this adaptation
is made available on the same terms.

The operative text is unmodified apart from filling in the template's placeholders and selecting among the options the
template offers. Specifically:

| Original | This document |
| --- | --- |
| `[PROJECT_NAME]`, `[SUBMISSION_INSTRUCTIONS]` (preamble) | North Shore Software Ltd.; sign electronically via <cla@northshoresoftware.ca> |
| `[NONOWNER_INSTRUCTIONS]` (§1 "Contribution", §3(d)) | Link to `CONTRIBUTING.md#third-party-material` |
| §2.2 optional `[or Your Affiliates]` | Omitted |
| §2.3 Options One–Five | **Option Five** adopted; Options One–Four removed |
| §2.3 `[LIST_OF_MEDIA_LICENSES]` | CC0-1.0, CC-BY-4.0, CC-BY-SA-4.0 |
| §6.1 `[JURISDICTION]` | British Columbia, Canada |
| Handwritten signature block | Removed; this Agreement is signed electronically |

The document was also reformatted as Markdown. No other changes were made to the wording of the Agreement.
