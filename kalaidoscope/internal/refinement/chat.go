...
func StreamApplyLeg(ctx context.Context, app core.App, sse *chat.SSE, refRec *core.Record, w *chat.TurnWriter, parts []api.UIMessagePart, lens string, pinned llmcontext.PinnedIDs, win *api.Window, parentModel string) {
