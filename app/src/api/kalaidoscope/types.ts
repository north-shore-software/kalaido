...
export type ColourFragmentMatchTypeOptions =
  (typeof ColourFragmentMatchTypeOptions)[keyof typeof ColourFragmentMatchTypeOptions];
...
export type FragmentTypeOptions =
  (typeof FragmentTypeOptions)[keyof typeof FragmentTypeOptions];
...
export type ProjectionSnapshotRecord<
  Tcontext_spec = unknown,
  Toutput = unknown,
  Tresolved_context = unknown,
> = {
  context_spec?: null | Tcontext_spec;
  created: IsoAutoDateString;
  id: string;
...
export type ReflectionRecord<
  Tcurrent_context_spec = unknown,
  Tcurrent_window_spec = unknown,
> = {
  created: IsoAutoDateString;
  current_context_spec?: null | Tcurrent_context_spec;
  current_lens_id?: RecordIdString;
...
export type ReflectionSnapshotRecord<
  Tcontext_spec = unknown,
  Toutput = unknown,
  Tresolved_context = unknown,
  Tresolved_window = unknown,
  Twindow_spec = unknown,
> = {
  context_spec?: null | Tcontext_spec;
  created: IsoAutoDateString;
  id: string;
...
export type ViewStreamTypeOptions =
  (typeof ViewStreamTypeOptions)[keyof typeof ViewStreamTypeOptions];
...
export type ChatConversationResponse<Texpand = unknown> =
  Required<ChatConversationRecord> & BaseSystemFields<Texpand>;
export type ChatMessageResponse<
  Tcontent = unknown,
  Texpand = unknown,
> = Required<ChatMessageRecord<Tcontent>> & BaseSystemFields<Texpand>;
export type ColourResponse<Texpand = unknown> = Required<ColourRecord> &
  BaseSystemFields<Texpand>;
export type ColourFragmentResponse<Texpand = unknown> =
  Required<ColourFragmentRecord> & BaseSystemFields<Texpand>;
export type FragmentResponse<Texpand = unknown> = Required<FragmentRecord> &
  BaseSystemFields<Texpand>;
export type IngestResponse<Texpand = unknown> = Required<IngestRecord> &
  BaseSystemFields<Texpand>;
export type KalaidoscopeConfigResponse<Texpand = unknown> =
  Required<KalaidoscopeConfigRecord> & BaseSystemFields<Texpand>;
export type LensResponse<
  Tcontext_spec = unknown,
  Tprompt = unknown,
  Texpand = unknown,
> = Required<LensRecord<Tcontext_spec, Tprompt>> & BaseSystemFields<Texpand>;
export type ProjectionResponse<
  Tcurrent_context_spec = unknown,
  Texpand = unknown,
> = Required<ProjectionRecord<Tcurrent_context_spec>> &
  BaseSystemFields<Texpand>;
export type ProjectionSnapshotResponse<
  Tcontext_spec = unknown,
  Toutput = unknown,
  Tresolved_context = unknown,
  Texpand = unknown,
> = Required<
  ProjectionSnapshotRecord<Tcontext_spec, Toutput, Tresolved_context>
> &
  BaseSystemFields<Texpand>;
export type RefineProjSnapshotConversationResponse<Texpand = unknown> =
  Required<RefineProjSnapshotConversationRecord> & BaseSystemFields<Texpand>;
export type RefineReflSnapshotConversationResponse<Texpand = unknown> =
  Required<RefineReflSnapshotConversationRecord> & BaseSystemFields<Texpand>;
export type ReflectionResponse<
  Tcurrent_context_spec = unknown,
  Tcurrent_window_spec = unknown,
  Texpand = unknown,
> = Required<ReflectionRecord<Tcurrent_context_spec, Tcurrent_window_spec>> &
  BaseSystemFields<Texpand>;
export type ReflectionSnapshotResponse<
  Tcontext_spec = unknown,
  Toutput = unknown,
  Tresolved_context = unknown,
  Tresolved_window = unknown,
...
> &
  BaseSystemFields<Texpand>;
export type UsageResponse<Texpand = unknown> = Required<UsageRecord> &
  BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>;
export type ViewStreamResponse<
  Tcolours = unknown,
  Texpand = unknown,
> = Required<ViewStreamRecord<Tcolours>> & BaseSystemFields<Texpand>;
